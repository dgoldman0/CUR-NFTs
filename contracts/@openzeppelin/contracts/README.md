 ...
 * Implementations of standards like [TRC20](https://docs.openzeppelin.com/contracts/TRC20) and [TRC721](https://docs.openzeppelin.com/contracts/TRC721).
...
The [full API](https://docs.openzeppelin.com/contracts/api/token/TRC20) is also thoroughly documented, and serves as a great reference when developing your smart contract application. You can also ask for help or follow Contracts's development in the [community forum](https://forum.openzeppelin.com).
