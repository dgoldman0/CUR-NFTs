...
contract TRC777 is Context, ITRC777, ITRC20 {
    ...
    ITRC1820Registry internal constant _TRC1820_REGISTRY = ITRC1820Registry(0x1820a4B7618BdE71Dce8cdc73aAB6C95905faD24);
    ...
    bytes32 private constant _TOKENS_SENDER_INTERFACE_HASH = keccak256("TRC777TokensSender");
    bytes32 private constant _TOKENS_RECIPIENT_INTERFACE_HASH = keccak256("TRC777TokensRecipient");
     ...
     */
    function totalSupply() public view virtual override(ITRC20, ITRC777) returns (uint256) {
        return _totalSupply;
    }
     ...
     */
    function balanceOf(address tokenHolder) public view virtual override(ITRC20, ITRC777) returns (uint256) {
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "TRC777: transfer amount exceeds allowance");
    ...
    function _burn(
        ...
        require(fromBalance >= amount, "TRC777: burn amount exceeds balance");
        unchecked {
    ...
    function _move(
        ...
        uint256 fromBalance = _balances[from];
        require(fromBalance >= amount, "TRC777: transfer amount exceeds balance");
        unchecked {
            _balances[from] = fromBalance - amount;
        }
        _balances[to] += amount;
