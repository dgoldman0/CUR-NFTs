...
import "@ttcrypto/openzeppelin-tron-contracts/contracts/token/ERC1155/ERC1155.sol";
import "@ttcrypto/openzeppelin-tron-contracts/contracts/access/Ownable.sol";
import "@ttcrypto/openzeppelin-tron-contracts/contracts/token/ERC20/IERC20.sol";
import "@ttcrypto/openzeppelin-tron-contracts/contracts/utils/Counters.sol";

contract TRC1155NftToken is ERC1155, Ownable {
    ...
    constructor(IERC20 _curAddress) public ERC1155("https://opensea-creatures-api.herokuapp.com/api/creature/"){
        tokenCounter = 1;
        curContract = _curAddress;
    }



    function createNft(uint256 _amount) public returns(uint256){
    ...
    function createNFT(uint256 cur, uint256 lockout_time, string memory tokenURI) public returns (uint256) {
        require(curContract != IERC20(address(0)), "Token address has not yet been set!");
