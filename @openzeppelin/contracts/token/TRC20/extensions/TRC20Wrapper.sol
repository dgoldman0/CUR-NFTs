...
/**
 * @dev Extension of the TRC20 token contract to support token wrapping.
 *
...
abstract contract TRC20Wrapper is TRC20 {
    ITRC20 public immutable underlying;
    ...
    function depositFor(address account, uint256 amount) public virtual returns (bool) {
        SafeTRC20.safeTransferFrom(underlying, _msgSender(), address(this), amount);
    ...
    function withdrawTo(address account, uint256 amount) public virtual returns (bool) {
        ...
        SafeTRC20.safeTransfer(underlying, account, amount);
        return true;
    }
