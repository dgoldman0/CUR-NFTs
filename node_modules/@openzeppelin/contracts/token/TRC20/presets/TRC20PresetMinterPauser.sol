...
import "../extensions/TRC20Pausable.sol";
 ...
 */
contract TRC20PresetMinterPauser is Context, AccessControlEnumerable, TRC20Burnable, TRC20Pausable {
     ...
     */
    constructor(string memory name, string memory symbol) TRC20(name, symbol) {
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 amount
    ) internal virtual override(TRC20, TRC20Pausable) {
